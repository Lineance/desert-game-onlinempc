...
def main() -> None:
    ...
    print("[Level4-Global] success:", result.success)
    print("[Level4-Global] final day:", result.final_state.day)
    print("[Level4-Global] final money:", result.final_state.money)
